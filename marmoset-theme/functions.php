...
class Marmoset_Theme {
	public static function init() {
		if( !is_admin() ) {
			wp_enqueue_script( 'marmoset-js', get_bloginfo('template_directory') . '/marmoset.js', array('jquery-ui-183'), 1, true );
			wp_enqueue_style( 'marmoset-960', get_bloginfo('template_directory') . '/960.css' );
			wp_enqueue_style( 'marmoset-style', get_bloginfo('template_directory') . '/style.css', 'marmoset-960' );
